...
<!--        常数类别管理-->
        ...
        <el-dialog  :visible.sync="outerVisible" width="80%" center style="padding: 0;margin: 0 auto">
            <div style="text-align: center;">
                <div slot="title" class="dialog-title" style="font-size: 14px;margin-bottom: 20px">常数项列表</div>
            ...
            <div slot="footer" class="dialog-footer">
                ...
                <el-button type="primary" @click="outerVisible = false" size="mini">关闭</el-button>
            </div>
        </el-dialog>
